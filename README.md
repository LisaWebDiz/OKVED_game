...
2. **Загрузка ОКВЭД**
   - Загружает `okved.json` по HTTPS с репозитория (файл обновляется ежедневно) с использованием локального файлового кэша, действительного в пределах календарного дня..
